...
function criacao(){
	if(document.getElementById("tipo").value == "logar"){
		document.getElementById("tipo").value = "criar";
		document.getElementById("label").innerHTML = "<br><br>Voltar";	
		document.getElementById("nome_botao").innerHTML = "Criar";
	} else{
		document.getElementById("tipo").value = "logar";
		document.getElementById("label").innerHTML = "<br><br>Criar novo";
		document.getElementById("nome_botao").innerHTML = "Entrar";
	}	
}
</script>
				...
				<form style="padding-top:40px" class="login100-form validate-form" action="/" method="post" accept-charset="utf-8">
					...
					<div id="logar">
						<div class="wrap-input100 validate-input">
							<input autocomplete="off" class="input100" type="text" name="email" id="email" required autofocus>
							<span class="focus-input100"></span>
							<span class="label-input100">Insira o Email</span>
						</div>
						<div class="wrap-input100 validate-input">
							<input autocomplete="off" class="input100" type="password" name="senha" id="senha" required >
							<span class="focus-input100"></span>
							<span class="label-input100">Insira a senha</span>
						</div>
						<div id="botaoEntrar" class="container-login100-form-btn">
							<button class="login100-form-btn">
								<span id="nome_botao">Entrar</span>
							</button>
						</div>
						<div style="cursor:pointer" onclick="criacao()" class="container-login100-form-btn">
							<span id="label" ><br><br>Criar novo</span>
						</div>
					</div>
					<input type="hidden" id="tipo" name="tipo" value="logar" />
				</form>
